...
Khas.Lighting.LIGHTS = {
    ...
    halogen: {
        fileName: "halogen",
        intensity: 80, variation: 6,
        offset_x: 0, offset_y: 0
    },
    halogenchalk: {
        fileName: "halogen",
        intensity: 60, variation: 100,
        offset_x: 0, offset_y: 0
    },
    halogendim: {
        fileName: "halogen",
        intensity: 50, variation: 10,
        offset_x: 0, offset_y: 0
    },
    halogenplayer: {
        fileName: "halogenplayer",
        intensity: 100, variation: 0,
        offset_x: 0, offset_y: -48
	},
	halogenplayer2: {
    ...
    halogen3: {
        fileName: "halogen",
        intensity: 100, variation: 0, size: 150,
        offset_x: 0, offset_y: 0
    },
    halogen4: {
        fileName: "halogen",
        intensity: 50, variation: 60, size: 100,
	...
	tungstendim: {
        fileName: "tungsten",
        intensity: 80, variation: 2,
        offset_x: 0, offset_y: 0
    },
	tungstendim2: {
        fileName: "tungsten",
        intensity: 70, variation: 8,
        offset_x: 0, offset_y: 0
    },
	tungstendim3: {
        fileName: "tungsten",
        intensity: 40, variation: 16,
        offset_x: 0, offset_y: 0
    },
    fluorescent: {
    ...
    broken: {
        fileName: "halogen",
        intensity: 40, variation: 10,
        offset_x: 0, offset_y: 0
    },
    spotlight1: {
        fileName: "flashlight",
        intensity: 80, variation: 10, size: 100,
        offset_x: 0, offset_y: 0
    },
    spotlight2: {
        fileName: "flashlight",
        intensity: 5, variation: 50, size: 100,
        offset_x: 0, offset_y: 0
    },
    spotlight3: {
        fileName: "flashlight",
        intensity: 60, variation: 10, size: 100,
        offset_x: 0, offset_y: 0
    },
    spotlight4: {
        fileName: "flashlight2",
        intensity: 20, variation: 0, size: 100,
        offset_x: 0, offset_y: 0
    },
    spotlight5: {
        fileName: "flashlight",
        intensity: 100, variation: 0, size: 100,
        offset_x: 0, offset_y: 0
    },
    flashlight: {
        fileName: "flashlight",
	...
	basement1: {
        fileName: "tungsten",
        intensity: 100, variation: 6, size: 100,
        offset_x: 0, offset_y: 0
    },
	basement2: {
        fileName: "tungsten",
        intensity: 60, variation: 24, size: 100,
        offset_x: 0, offset_y: 0
    },
	basement3: {
        fileName: "tungsten",
        intensity: 80, variation: 32, size: 60,
        offset_x: 0, offset_y: 0
    },
	plant: {
        fileName: "sunlight",
    ...
    candledim: {
        fileName: "candle",
        intensity: 40, variation: 15,
        offset_x: 0, offset_y: 0
    },
	candleplayer: {
        fileName: "candleplayer",
        intensity: 70, variation: 20,
        offset_x: 0, offset_y: -54
    },
    // TORCH
    torch: {
        fileName: "torch",
        intensity: 60, variation: 20,
        offset_x: 0, offset_y: 0
    },
	torch_dim: {
        fileName: "torch",
        intensity: 20, variation: 10,
        offset_x: 0, offset_y: 0
    },
    torch_big: {
        fileName: "torch",
    ...
    red_torch: {
        fileName: "red2",
        intensity: 80, variation: 100,
        offset_x: 0, offset_y: 0
    },
    red_torch2: {
        fileName: "red2",
        intensity: 80, variation: 50,
        offset_x: 0, offset_y: 0
	},
	red_torch3: {
        fileName: "red",
        intensity: 80, variation: 15,
        offset_x: 0, offset_y: 0
    },
    green_torch: {
        fileName: "green",
